...
```mermaid
flowchart TD
    M1["M1 | Org 5"] --> M1KA["Knowledge: Basic business understanding"]
    M1 --> M1LI["Leadership: Day-to-day supervision"]
    M1 --> M1IA["Impact: Weekly execution and task quality"]
    M1 --> M1PS["Problem Solving: Limited scope, established practices"]
    M1 --> M1CI["Collaboration: Direct, factual communication"]
```
...
```mermaid
flowchart TD
    M2["M2 | Org 6"] --> M2KA["Knowledge: Experienced team and company awareness"]
    M2 --> M2LI["Leadership: Guides subordinates and resolves problems"]
    M2 --> M2IA["Impact: Operational plans and monthly targets"]
    M2 --> M2PS["Problem Solving: Day-to-day technical and operational issues"]
    M2 --> M2CI["Collaboration: Explains information to peer groups"]
```
...
```mermaid
flowchart TD
    M3["M3 | Org 7"] --> M3KA["Knowledge: Advanced business and departmental integration"]
    M3 --> M3LI["Leadership: Coaches one or more teams"]
    M3 --> M3IA["Impact: Translates plans into execution"]
    M3 --> M3PS["Problem Solving: Diverse scope, multiple factors"]
    M3 --> M3CI["Collaboration: Cross-functional recommendations"]
```
...
```mermaid
flowchart TD
    M4["M4 | Org 8"] --> M4KA["Knowledge: Establishes policies and work plans"]
    M4 --> M4LI["Leadership: Leads multiple related teams"]
    M4 --> M4IA["Impact: Departmental results over multiple years"]
    M4 --> M4PS["Problem Solving: Complex organizational issues"]
    M4 --> M4CI["Collaboration: Persuades in sensitive situations"]
```
...
```mermaid
flowchart TD
    M5["M5 | Org 9"] --> M5KA["Knowledge: Mastery, industry knowledge, strategy"]
    M5 --> M5LI["Leadership: Directs a major functional area"]
    M5 --> M5IA["Impact: Broad functional results and long horizon"]
    M5 --> M5PS["Problem Solving: Highly complex business challenges"]
    M5 --> M5CI["Collaboration: Negotiates significant executive matters"]
```
...
```mermaid
flowchart TD
    M6["M6 | Org 10"] --> M6KA["Knowledge: Function-level vision and company policy"]
    M6 --> M6LI["Leadership: Leads through directors and managers"]
    M6 --> M6IA["Impact: Multi-functional objectives and company success"]
    M6 --> M6PS["Problem Solving: Abstract and novel business issues"]
    M6 --> M6CI["Collaboration: Influences strategy and policymaking"]
```
