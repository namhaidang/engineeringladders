...
```mermaid
flowchart TD
    P1["P1 | Org 4"] --> P1KA["Knowledge: Basic concepts and guidelines"]
    P1 --> P1LI["Leadership: Focused on own contributions"]
    P1 --> P1IA["Impact: Limited to own work team"]
    P1 --> P1PS["Problem Solving: Limited scope, existing procedures"]
    P1 --> P1CI["Collaboration: Shares straightforward information"]
```
...
```mermaid
flowchart TD
    P2["P2 | Org 5"] --> P2KA["Knowledge: Expanded discipline knowledge"]
    P2 --> P2LI["Leadership: Informal guidance to teammates"]
    P2 --> P2IA["Impact: Improves own work and team quality"]
    P2 --> P2PS["Problem Solving: Moderate scope with precedent"]
    P2 --> P2CI["Collaboration: Builds productive relationships"]
```
...
```mermaid
flowchart TD
    P3["P3 | Org 6"] --> P3KA["Knowledge: In-depth, cross-discipline awareness"]
    P3 --> P3LI["Leadership: Resource to immediate team"]
    P3 --> P3IA["Impact: Own team and related teams"]
    P3 --> P3PS["Problem Solving: Diverse scope, works independently"]
    P3 --> P3CI["Collaboration: Persuades and builds consensus"]
```
...
```mermaid
flowchart TD
    P4["P4 | Org 7"] --> P4KA["Knowledge: Specialized depth and breadth"]
    P4 --> P4LI["Leadership: Recognized resource beyond own team"]
    P4 --> P4IA["Impact: Departmental and tactical business results"]
    P4 --> P4PS["Problem Solving: Complex issues, leads others"]
    P4 --> P4CI["Collaboration: Negotiates difficult concepts"]
```
...
```mermaid
flowchart TD
    P5["P5 | Org 8"] --> P5KA["Knowledge: Expert across specialized fields"]
    P5 --> P5LI["Leadership: Company expert shaping principles"]
    P5 --> P5IA["Impact: Shapes functional direction and resources"]
    P5 --> P5PS["Problem Solving: Significant, unique issues"]
    P5 --> P5CI["Collaboration: Persuades senior stakeholders"]
```
...
```mermaid
flowchart TD
    P6["P6 | Org 9"] --> P6KA["Knowledge: Internal thought leader and advisor"]
    P6 --> P6LI["Leadership: Cross-functional expert and strategist"]
    P6 --> P6IA["Impact: Multi-function and strategic company goals"]
    P6 --> P6PS["Problem Solving: Novel methods for strategic issues"]
    P6 --> P6CI["Collaboration: Influences key decision makers"]
```
...
```mermaid
flowchart TD
    P7["P7 | Org 10"] --> P7KA["Knowledge: External thought leadership"]
    P7 --> P7LI["Leadership: Sets technical direction across disciplines"]
    P7 --> P7IA["Impact: Shapes overall company direction"]
    P7 --> P7PS["Problem Solving: Abstract, groundbreaking solutions"]
    P7 --> P7CI["Collaboration: Guides leadership on critical issues"]
```
